within Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZoneVAV.Economizers.Validation;
model Controller_Disable
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZoneVAV.Economizers.Controller economizer(
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZoneVAV.Economizers.Controller economizer1(
    final use_enthalpy=true,
    final yFanMin=yFanMin,
    final yFanMax=yFanMax,
    final VOutMin_flow=VOutMin_flow,
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZoneVAV.Economizers.Controller economizer2(
    final yFanMin=yFanMin,
    final yFanMax=yFanMax,
    final VOutMin_flow=VOutMin_flow,
    final VOutDes_flow=VOutDes_flow,
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/SingleZoneVAV/Economizers/Validation/Controller_Disable.mos"
    "Simulate and plot"),
  Icon(graphics={
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZoneVAV.Economizers.Controller\">
Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZoneVAV.Economizers.Controller</a>
