...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/SingleZoneVAV/Economizers/Validation/Controller_Mod_DamLim.mos"
    "Simulate and plot"),
  Icon(graphics={
...
Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZoneVAV.Economizers.Controller</a> control loops:
