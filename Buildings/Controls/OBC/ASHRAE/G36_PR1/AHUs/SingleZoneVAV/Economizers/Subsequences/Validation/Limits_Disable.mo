...
model Limits_Disable
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZoneVAV.Economizers.Subsequences.Limits damLim1(
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZoneVAV.Economizers.Subsequences.Limits damLim2(
    final yFanMin=yFanMin,
    final yFanMax=yFanMax,
    final VOutMin_flow=VOutMin_flow,
    final VOutDes_flow=VOutDes_flow)
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZoneVAV.Economizers.Subsequences.Limits damLim3(
    final yFanMin=yFanMin,
    final yFanMax=yFanMax,
    final VOutMin_flow=VOutMin_flow,
    final VOutDes_flow=VOutDes_flow)
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/SingleZoneVAV/Economizers/Subsequences/Validation/Limits_Disable.mos"
    "Simulate and plot"),
