within Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZoneVAV.Economizers.Subsequences.Validation;
model Enable_TOut_hOut
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZoneVAV.Economizers.Subsequences.Enable enaDis
    "Multi zone VAV AHU economizer enable disable sequence"
    annotation (Placement(transformation(extent={{-80,-40},{-60,-20}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZoneVAV.Economizers.Subsequences.Enable enaDis1
    "Multi zone VAV AHU economizer enable disable sequence"
    annotation (Placement(transformation(extent={{80,-40},{100,-20}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZoneVAV.Economizers.Subsequences.Enable enaDis2(
...
equation
  ...
  connect(outDamPosMin.y, enaDis1.uOutDamPosMin)
    annotation (Line(points={{-219,-110},{-190,-110},{-190,-64},{12,-64},{12,-34},{79,-34}},
      color={0,0,127}));
  ...
  connect(TOutCut.y, enaDis2.TOutCut)
    annotation (Line(points={{-139,90},{-120,90},{-120,120},{188,120},{188,-22},{219,-22}},
      color={0,0,127}));
  ...
  connect(supFanSta.y, enaDis1.uSupFan)
    annotation (Line(points={{-179,-32},{-160,-32},{-160,-12},{-20,-12},{-20,-28},{79,-28}},
    color={255,0,255}));
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/MultiZoneVAV/Economizers/Subsequences/Validation/Enable_TOut_hOut.mos"
    "Simulate and plot"),
  Icon(graphics={
        Ellipse(
          lineColor={75,138,73},
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZoneVAV.Economizers.Subsequences.Enable\">
Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZoneVAV.Economizers.Subsequences.Enable</a>
