...
model Limits_LoopDisable
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZoneVAV.Economizers.Subsequences.Limits damLim
    "Multi zone VAV AHU minimum outdoor air control - damper position limits"
    annotation (Placement(transformation(extent={{-120,-20},{-100,0}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZoneVAV.Economizers.Subsequences.Limits damLim1
    "Multi zone VAV AHU minimum outdoor air control - damper position limits"
    annotation (Placement(transformation(extent={{20,-20},{40,0}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZoneVAV.Economizers.Subsequences.Limits damLim2
    "Multi zone VAV AHU minimum outdoor air control - damper position limits"
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/MultiZoneVAV/Economizers/Subsequences/Validation/Limits_LoopDisable.mos"
    "Simulate and plot"),
