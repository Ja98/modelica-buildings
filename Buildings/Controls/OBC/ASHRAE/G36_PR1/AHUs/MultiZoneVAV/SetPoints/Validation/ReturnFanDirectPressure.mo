within Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZoneVAV.SetPoints.Validation;
model ReturnFanDirectPressure
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZoneVAV.SetPoints.ReturnFanDirectPressure retFanPre(
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZoneVAV.SetPoints.ReturnFanDirectPressure retFanPre1(
    k=0.5)
    "Return fan control with direct building pressure"
    annotation (Placement(transformation(extent={{20,10},{40,30}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZoneVAV.SetPoints.ReturnFanDirectPressure retFanPre2
    "Return fan control with direct building pressure"
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/MultiZoneVAV/SetPoints/Validation/ReturnFanDirectPressure.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZoneVAV.SetPoints.ReturnFanDirectPressure\">
Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZoneVAV.SetPoints.ReturnFanDirectPressure</a>
